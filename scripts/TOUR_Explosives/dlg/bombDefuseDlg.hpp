...
class TOUR_EXPLOSIVES_RscStructuredText : TOUR_EXPLOSIVES_RscText
{
...
class TOUR_EXPLOSIVES_RscImage : TOUR_EXPLOSIVES_RscText
{
	style = ST_PICTURE;
	w = 0.055;
	h = 0.065;
};
class TOUR_EXPLOSIVES_RscShortcutButton
{
	idc = -1;
	type = 16;
	style = ST_LEFT;
...
#define __sizeX 0.9
#define __sizeY 0.45
class TOUR_EXPLOSIVES_bombDefuseQ
{
	idd = 314258;
	movingEnable = 0;
	...
	onLoad = "TOUR_EXPLOSIVES_defuseAgree = false; ""dynamicBlur"" ppEffectEnable true; ""dynamicBlur"" ppEffectAdjust [1.6]; ""dynamicBlur"" ppEffectCommit 0;";
	onUnload = """dynamicBlur"" ppEffectEnable false;";
	//onKeyDown = "null = _this execVM ""scripts\TOUR_EXPLOSIVES\bombDefuseKey.sqf"";";
	
	class Background : TOUR_EXPLOSIVES_RscText
	{
	...
	class Header : TOUR_EXPLOSIVES_RscStructuredText
	{
		x = __posX;
	...
	class HelpText : Header
	{
		...
		h = 0.2;
		size = 0.032;
		text = "You are not a trained EOD operative. Defusing the bomb is probably not a good idea...<br/>Are you sure you want to try anyway?";
	...
	class BtnYes : TOUR_EXPLOSIVES_RscShortcutButton
	{	
		x = __EVAL(__posX + 0.25);
		y = __EVAL(__posY + 0.30);
		text = "Yes";
		action = "TOUR_EXPLOSIVES_defuseAgree = true;closeDialog 314259;";
	};
	class BtnNo : BtnYes
	{
		x = __EVAL(__posX + 0.475);
		text = "No";
		action = "closeDialog 314259;";
	};
};
...
#define __sizeX 0.9
#define __sizeY 0.65
class TOUR_EXPLOSIVES_bombDefuse
{
	idd = 314259;
	movingEnable = 0;
	...
	onLoad = "TOUR_EXPLOSIVES_defuseSequence = """"; ""dynamicBlur"" ppEffectEnable true; ""dynamicBlur"" ppEffectAdjust [1.6]; ""dynamicBlur"" ppEffectCommit 0;";
	onUnload = """dynamicBlur"" ppEffectEnable false;";
	onKeyDown = "null = _this execVM ""scripts\TOUR_EXPLOSIVES\bombDefuseKey.sqf"";";
	...
	class BtnStart : TOUR_EXPLOSIVES_RscShortcutButton
	{
		idc = 1;
		x = __EVAL(__posX + 0.25);
		y = __EVAL(__posY + 0.33);
		text = "Start";
		action = "TOUR_EXPLOSIVES_defuseStart = true;";
	};
	...
	class Sequence1Pic : TOUR_EXPLOSIVES_RscImage
	{
		idc = 21;
		x = __EVAL(__posX + 0.227);
		y = __EVAL(__posY + 0.52);
		text = "scripts\TOUR_EXPLOSIVES\dlg\unknown.paa";
	};
