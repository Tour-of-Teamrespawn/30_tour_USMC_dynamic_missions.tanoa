...
}else
{
	...
	_buttonEnd ctrlSetText "REQUEST ASSAULT FORCE";
	_textInfo = _textInfo + "
	<t size='0.85' font='TahomaB' color='#D0D0D0' align='left' valign='top'>REQUEST ASSAULT FORCE: Press the REQUEST ASSAULT FORCE button in order to give the green light to the main force.</t>
";
};
