...
if ((str (getMarkerPos _mkr)) != "[0,0,0]") then
{
	...
	//Update Marker
	_mkr setMarkerDirLocal (round _position);
};

//Help Text
_textHelp ctrlSetStructuredText parseText format ["
	<img size='3' image='\a3\ui_f\data\map\markers\military\unknown_ca.paa'/> <t size='1.25' font='puristaMedium'>%1/360</t>
	<br/>
	<br/>
	<t size='0.85' font='TahomaB' color='#D0D0D0' align='left' valign='top'>Area of Operation Angle.%2</t>
